...
- **Single-file component:** The entire app lives in `OrbitThreadApp.jsx` (~2950 lines). This is intentional for rapid iteration — keeps everything visible and self-contained. Future phases should split into modules.
